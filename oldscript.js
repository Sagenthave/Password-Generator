...
function getPasswordOptions() { 
  var userlength = parseInt(prompt("How long would you like your password? 8-128"));
...
console.log(getPasswordOptions.passwordOptions);
...
// 1/4 options selected
  ...
  for (i=0; i < getPasswordOptions.userlength; i++) {
    var randomChar = resultPassword[Math.floor(Math.random() * resultPassword.length)];
